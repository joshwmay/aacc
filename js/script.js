...
function mapper() {
    var mymap = L.map('mapid').setView([39.311085, -77.291394], 8);
...
window.addEventListener("load", () => {
    ...
    var calc_avg = [
        ...
        { label: 'Garrett College', y: 63340 },
        { label: 'Carroll Community College', y: 619724 },
        { label: 'Wor-Wic Community College', y: 68006 },
        { label: 'Hagerstown Community College', y: 66010 },
        { label: 'Harford Community College', y: 69519 },
        { label: 'Baltimore City Community College', y: 72099.67 },
        { label: 'Cecil College', y: 63548 },
        { label: 'Chesapeake College', y: 72901 },
        { label: 'Frederick Community College', y: 74298 },
        { label: "Prince George’s Community College", y: 72097 },
        { label: 'Anne Arundel Community College', y: 74466 },
        { label: 'Community College Average', y: 70325 },
        { label: 'College of Southern Maryland', y: 75114 },
        { label: 'Howard Community College', y: 77464.5 },
        { label: 'Montgomery College', y: 79651 },
        { label: 'Community College of Baltimore County', y: 82618 }
    ];
    var _1yr = [{
            label: 'Chesapeake College',
            y: .1
    ...
    var res = [{ label: 'Wor-Wic Community College ', y: 134 },
        { label: 'Hagerstown Community College ', y: 136 },
        { label: 'Baltimore City Community College ', y: 137 },
        { label: 'Anne Arundel Community College ', y: 140 },
        { label: 'Garrett College ', y: 143 },
        { label: 'Allegany College of Maryland ', y: 145 },
        { label: 'Frederick Community College ', y: 149 },
        { label: 'Harford Community College ', y: 153 },
        { label: 'Prince George’s Community College ', y: 155 },
        { label: 'Cecil College ', y: 156 },
        { label: 'Chesapeake College ', y: 158 },
        { label: 'College of Southern Maryland ', y: 158 },
        { label: 'Howard Community College ', y: 164 },
        { label: 'Community College of Baltimore County ', y: 164 },
        { label: 'Carroll Community College ', y: 165 },
        { label: 'Montgomery College ', y: 171 },
    ];
    var oos = [
        { label: 'Wor-Wic Community College', y: 320 },
        { label: 'Hagerstown Community College', y: 265 },
        { label: 'Baltimore City Community College', y: 308 },
        {
            label: 'Anne Arundel Community College',
            y: 412,
            indexLabel: "AACC",
        ...
        { label: 'Garrett College', y: 333 },
        { label: 'Allegany College of Maryland', y: 314 },
        { label: 'Frederick Community College', y: 390 },
        { label: 'Harford Community College', y: 334 },
        { label: 'Prince George’s Community College', y: 350 },
        { label: 'Cecil College', y: 310 },
        { label: 'Chesapeake College', y: 321 },
        { label: 'College of Southern Maryland', y: 376 },
        { label: 'Howard Community College', y: 301 },
        { label: 'Community College of Baltimore County', y: 373 },
        { label: 'Carroll Community College', y: 313 },
        { label: 'Montgomery College', y: 451 },
    ];
    var ooa = [
        { label: 'Wor-Wic Community College', y: 260 },
        { label: 'Hagerstown Community College', y: 204 },
        { label: 'Baltimore City Community College', y: 137 },
        { label: 'Anne Arundel Community College', y: 249 },
        { label: 'Garrett College', y: 283 },
        { label: 'Allegany College of Maryland', y: 258 },
        { label: 'Frederick Community College', y: 294 },
        { label: 'Harford Community College', y: 244 },
        { label: 'Prince George’s Community College', y: 249 },
        { label: 'Cecil College', y: 246 },
        { label: 'Chesapeake College', y: 237 },
        { label: 'College of Southern Maryland', y: 276 },
        { label: 'Howard Community College', y: 253 },
        { label: 'Community College of Baltimore County', y: 267 },
        { label: 'Carroll Community College', y: 247 },
        { label: 'Montgomery College', y: 331 },
